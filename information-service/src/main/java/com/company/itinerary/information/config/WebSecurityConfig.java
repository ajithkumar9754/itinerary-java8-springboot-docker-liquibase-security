...
import com.company.itinerary.information.properties.RoleProperties;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.inMemoryAuthentication().withUser(rolePropetiies.getTraveluser())
				.password(passwordEncoder().encode(rolePropetiies.getTraveluserPassword())).roles("TRAVEL_USER");
